...
# -------------------------------
#st.image("https://via.placeholder.com/800x200.png?text=EGSA2025+PLC+Banner", use_column_width=True)
...
# -------------------------------
# Member Benefits (Placeholder Icons)
# -------------------------------
...
if st.button("Contact Us / Join Now"):
    st.write("Thank you for your interest! Please contact us via phone or email to join EGSA2025.")
